// API Serverless Handler para envio de e-mails via Resend sem bloqueio de CORS
// Funciona na Vercel, Netlify, Firebase Functions ou Node server
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const RESEND_API_KEY = typeof Buffer !== 'undefined'
      ? Buffer.from('cmVfQ1paV2ZqQWtfM2U4NGJ0M1VDZkFDTTl1WWNvQmZHVWpX', 'base64').toString('utf8')
      : atob('cmVfQ1paV2ZqQWtfM2U4NGJ0M1VDZkFDTTl1WWNvQmZHVWpX');
